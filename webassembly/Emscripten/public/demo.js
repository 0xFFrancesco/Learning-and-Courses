...
function myJSFunc1(x){ console.log('test JS from C using EM_JS! - ' + x + '.'); }
...
/** @type {function(...*):?} */
var ___em_js__myJSFunc1 = Module["___em_js__myJSFunc1"] = createExportWrapper("__em_js__myJSFunc1");
